...
(cl:defmethod cl:initialize-instance :after ((m <Servo_Control-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo_Control-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<Servo_Control-request> is deprecated: use robot-srv:Servo_Control-request instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Servo_Control-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-srv:angle-val is deprecated.  Use robot-srv:angle instead.")
  (angle m))
...
(cl:defmethod cl:initialize-instance :after ((m <Servo_Control-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo_Control-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-srv:<Servo_Control-response> is deprecated: use robot-srv:Servo_Control-response instead.")))
